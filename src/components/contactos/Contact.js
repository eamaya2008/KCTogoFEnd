...
const Contacto = () => {
    ...
    const defaultUrl = server + '/lista?page=';
    ...
    const handleSearchContacto = (e) => {
        ...
        if (cotNombre.length !== 0) {
            setUrl(server + '/nombre?name=' + cotNombre + '&page=')
            setPageNumber(0)
        } else {
            setUrl(defaultUrl)
            setPageNumber(0)
    ...
    const handleSearchEmpresa = (e) => {
        ...
        if (cliRazSoc.length !== 0) {
            setUrl(server + '/empresa?razsoc=' + cliRazSoc + '&page=')
            setPageNumber(0)
        } else {
            setUrl(defaultUrl)
            setPageNumber(0)
    ...
    return (
        <div className="contactos-data">
            <div className="contactos-header-search">
                        ...
                        {contactData.map((contacto, index) => {
                            return (
                                ...
                                >
                                    ...
                                    <td id="cliente">{contacto.cliente.cliRazSoc}</td>
                                    <td id="modificar"
